...
let tradOne={
    ...
    "measurements": "24cm x 24cm x 20cm",    
}
let tradOneImg = "./assets/productImgs/pramidSmallOne.jpg"
...
let tradTwo={
    ...
    "measurements": "36cm x 36cm x 30cm",    
}
let tradTwoImg = "./assets/productImgs/pyramidLrg.jpg"

let hangOne={
    "type": "Colgante en tierra",
    "name": "Mini-Huerto Colgante",
    "price": 18,
    "details": [
        "2 plantitas (pueden ser especies variadas)",
        "Util para llaves y otros elementos de uso diario!",
        "Disponible en varios colores"
        ],
    "measurements": "34cm x 12cm x 20cm",    
}
let hangOneImg = "./assets/productImgs/hangingOne.jpg"
...
let hangTwo={
    ...
    "details": [
        ...
        "Elegante diseño colgante",
        "Disponible en varios colores"
        ],
    "measurements": "24cm x 75cm x 20cm",    
}
let hangTwoImg = "./assets/productImgs/hangingTwo.jpg"
...
let hydroOneImg2 = "./assets/productImgs/hydroTwo.jpg"
let hydroOneImg23 = "./assets/productImgs/hydroTwoTwo.jpg"
...
export default function Home(){
    ...
    const PDFLink=()=>{
        return(<>
        <p style={{textAlign: "center", fontSize: "2em", color: "cromson", fontWeight: "600" }}> Catálogo actualizado!! </p>
            <br></br>
            <br></br>
        </>)
    }
    ...
    const homeScrollers=()=>{
        return(<>
            <div className={styles.homeProductAnchors} >
                ...
                <div className={styles.anchorContainer} style={{textAlign:"center", display: "flex", justifyContent:"center", alignItems: "center" }}>
    ...
    const prodSliders=()=>{
        return(
            ...
            <div className={styles.productBar} > 
                <h2 className={styles.prodBarTitle} id="hangAnchor" > Huertos Colgantes en Tierra: </h2>
                <div  style={{display: "flex", overflowX: "scroll",} }  >
                {ProdDisplayer(hangOne, hangOneImg)};
                {ProdDisplayer(hangTwo, hangTwoImg)};
                </div>
                <p style={{textAlign: "center", fontSize: "1.3em"}} >
                <i>&#8640; desplaza para más opciones: &#8640;</i> </p>
            </div>
